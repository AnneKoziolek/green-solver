...
public class SATCanonizerTest {
	...
	public void test09() {
		...
		IntVariable v2 = new IntVariable("bb", 0, 99);
		IntVariable v3 = new IntVariable("cc", 0, 99);
		Operation o1 = new BinaryOperation(Operation.Operator.ADD, v1, v2);
		Operation o2 = new BinaryOperation(Operation.Operator.ADD, v1, v3);
		Operation o3 = new BinaryOperation(Operation.Operator.LT, o1, o2);
	...
	public void test10() {
		...
		IntVariable v3 = new IntVariable("cc", 0, 99);
		Operation o1 = new BinaryOperation(Operation.Operator.ADD, v1, v2);
		Operation o2 = new BinaryOperation(Operation.Operator.SUB, v1, v3);
		Operation o3 = new BinaryOperation(Operation.Operator.LT, o1, o2);
		check(o3, "(aa+bb)<(aa-cc)", "1*v+1*v+1<=0");
	}
	...
	public void test11() {
		...
		IntVariable v2 = new IntVariable("bb", 0, 99);
		Operation o1 = new BinaryOperation(Operation.Operator.ADD, v1, v2);
		Operation o2 = new BinaryOperation(Operation.Operator.SUB, v2, v1);
		Operation o3 = new BinaryOperation(Operation.Operator.LT, o1, o2);
	...
	public void test12() {
		...
		IntVariable v1 = new IntVariable("aa", 0, 99);
		IntVariable v2 = new IntVariable("bb", 0, 99);
		Operation o1 = new BinaryOperation(Operation.Operator.ADD, c1, c2);
		Operation o2 = new BinaryOperation(Operation.Operator.MUL, o1, v1);
		Operation o3 = new BinaryOperation(Operation.Operator.LT, o2, v2);
	...
	public void test13() {
		...
		IntVariable v2 = new IntVariable("bb", 0, 99);
		Operation o1 = new BinaryOperation(Operation.Operator.ADD, c1, c2);
		Operation o2 = new BinaryOperation(Operation.Operator.MUL, v1, o1);
		Operation o3 = new BinaryOperation(Operation.Operator.LT, o2, v2);
	...
	public void test14() {
		...
		IntVariable v1 = new IntVariable("aa", 0, 99);
		IntVariable v2 = new IntVariable("bb", 0, 99);
		Operation o1 = new BinaryOperation(Operation.Operator.SUB, v1, v2);
		Operation o2 = new BinaryOperation(Operation.Operator.MUL, o1, c1);
		Operation o3 = new BinaryOperation(Operation.Operator.LT, o2, v1);
	...
	public void test15() {
		...
		IntVariable v2 = new IntVariable("bb", 0, 99);
		Operation o1 = new BinaryOperation(Operation.Operator.SUB, v1, v2);
		Operation o2 = new BinaryOperation(Operation.Operator.MUL, c1, o1);
		Operation o3 = new BinaryOperation(Operation.Operator.LT, o2, v1);
	...
	public void test16() {
		...
		IntVariable v1 = new IntVariable("aa", 0, 99);
		IntVariable v2 = new IntVariable("bb", 0, 99);
		Operation o1 = new BinaryOperation(Operation.Operator.MUL, v1, c1);
		Operation o2 = new BinaryOperation(Operation.Operator.MUL, c2, v1);
		Operation o3 = new BinaryOperation(Operation.Operator.ADD, o1, o2);
		Operation o4 = new BinaryOperation(Operation.Operator.LT, o3, v2);
	...
	public void test17() {
		IntConstant c1 = new IntConstant(2);
		Operation o1 = new BinaryOperation(Operation.Operator.LT, c1, c1);
		check(o1, "2<2", "0==1");
	}
	...
	public void test18() {
		...
		IntVariable v1 = new IntVariable("aa", 0, 99);
		Operation o1 = new BinaryOperation(Operation.Operator.LT, c1, c1);
		Operation o2 = new BinaryOperation(Operation.Operator.LT, v1, c1);
		Operation o3 = new BinaryOperation(Operation.Operator.AND, o1, o2);
	...
	public void test19() {
		IntConstant c1 = new IntConstant(2);
		Operation o1 = new BinaryOperation(Operation.Operator.LE, c1, c1);
		check(o1, "2<=2", "0==0");
	}
