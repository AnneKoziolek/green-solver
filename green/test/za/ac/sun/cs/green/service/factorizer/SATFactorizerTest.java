...
public class SATFactorizerTest {
	...
	public void test02() {
		...
		Operation o3 =  new BinaryOperation(Operation.Operator.AND, o2, o1);
...
//		Operation o1 =  new BinaryOperation(Operation.Operator.EQ, v1, v2);
	...
	public void test05() {
		...
		Operation o3 =  new BinaryOperation(Operation.Operator.EQ, v6, v4);
		Operation o4 =  new BinaryOperation(Operation.Operator.EQ, v5, v6);
		Operation o34 =  new BinaryOperation(Operation.Operator.AND, o4, o2);
		Operation o234 =  new BinaryOperation(Operation.Operator.AND, o3, o34);
		Operation o1234 =  new BinaryOperation(Operation.Operator.AND, o1, o234);
	...
	public void test06() {
		...
		Operation o123 =  new BinaryOperation(Operation.Operator.AND, o12, o3);
